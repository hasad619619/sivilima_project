        ...
        <main role="main" class="container">
            ...
            <div class="row mt-5">
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active" aria-current="page">Issued Cheques</li>
                    </ol>
                </nav>
            </div>
            ...
            <div class="row mt-2">
                <div class="card col-md-12" style="box-shadow: 0 4px 8px 0 rgba(0, 0, 0, 0.2), 0 6px 20px 0 rgba(0, 0, 0, 0.19);">
                    <div class="card-body">
                        <form method="get" action="issuedcheques.jsp" >
                            <div class="row">
                                <div class="col-md-4">
                                                     ...
                                                     %>
                                                        <tr>
                                                            ...
                                                            <td>
                                                             ...
                                                             <button  class="btn btn-outline-dark btn-sm view_dev"  value='<%=DE.getIdinvoiceRecipt()%>' value="">status</button>
            ...
            <div class="modal-dialog modal-lg" role="document">
              <div class="modal-content">
                <div class="modal-header">
                  <h5 class="modal-title">Issued Cheque Processing</h5>
                ...
                <div class="modal-footer">
                  <div class="col-md-11">
                       <div class="btn-group mb-3" role="group" aria-label="Basic example">
                           ...
                           <button  class="btn btn-success btn_deposit" id="btn_deposit" ><span class="fa fa-book mr-2"></span>RELEASE FROM BANK</button>
                           <button  class="btn btn-dark btn_delete" id="btn_delete" ><span class="fa fa-book mr-2"></span>DELETE</button>
                           <button  class="btn btn-success btn_paytothird" id="btn_paytothird" ><span class="fa fa-book mr-2"></span>OD</button>
           ...
           function changeStatus(stat,acc_id,receptid,t){
               if(acc_id === 0 || receptid === 0){
                   ...
                   swal("empty data please retry !");
                                ...
                                $.ajax({
                                 url: 'changeChequeStatusIsshuedServlet',
                                 data: {
                                         stat: stat,
                                         acc: acc_id,
                                         t: t,
