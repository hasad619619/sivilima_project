            ...
            <div class="row mt-5">
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active" aria-current="page">Stock return Analysis</li>
                    </ol>
                </nav>
            </div>
            <div class="row mt-2">
                <div class="card col-md-12" style="box-shadow: 0 4px 8px 0 rgba(0, 0, 0, 0.2), 0 6px 20px 0 rgba(0, 0, 0, 0.19);">
                    <div class="card-body">
                        <form method="get" action="stockreturnanalyse.jsp" >
                            <div class="row">
                                <div class="col-md-4">
                        ...
                        <table class="table table-light" id="tbl1">
                            ...
                            <tbody>
                                <%
                                    ...
                                    for (StockReturn ir : IR) {
                                        total_sales=total_sales + ir.getAmount();
                                        
                                %>
                                <tr>
                                    <td><%=ir.getIdstockReturn() %></td>
