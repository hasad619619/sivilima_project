        ...
        <main role="main" class="container">
            ...
            <div class="row mt-5">
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active" style="font-size: 16px;" aria-current="page">List - Release Payment</li>
            ...
            <div class="row mt-2">
                <div class="card col-md-12" style="box-shadow: 0 4px 8px 0 rgba(0, 0, 0, 0.2), 0 6px 20px 0 rgba(0, 0, 0, 0.19);">
                    <div class="card-body">
                        <form method="get" action="purchaserecieptslist.jsp" >
                            <div class="row">
                                <div class="col-md-4">
                        ...
                        <table class="table table-light " id="tbl1">
                            <thead>
                                <tr>
                                    ...
                                    <th style="background-color: #10ac84 !important; color: white !important; ">Paid User</th>
