        ...
        <main role="main" class="container"  >
                ...
                <div class="input-group input-group-append">
                    <div class="mr-2">
                        <div class="input-group ">
                            ...
                            <select class="form-control s2" style="width:388px ;height: 35px;" id="customer" name="customer">
                                ...
                                <input type="button" class=" btn-info" value="Add New" onclick="location.replace('account.jsp');">
                        </div>
                    </div>
                    <div class="mr-2">
                        <div class="input-group">
                            ...
                            <select class="form-control" style="width:153px ;height: 35px;" id="type" name="type">
                    ...
                    <div class="mr-2">
                        <div class="input-group ">
                            <div class="input-group-prepend">
                             ...
                             <input type="text" class="form-control" style="width:742px;height: 35px;" id="item" name="item"> 
                        </div>
                    </div>
                </div>   
            </div>
                ...
                <table class="table table-sm  table-bordered" id="">
                    <thead>
                        <tr>
                            ...
                            <th style="background-color:#10ac84 !important; color: white !important; ">REMOVE</th>
                        </tr>
                    </thead>
                    <tbody>
                        <%                            
            ...
            <div class="row mt-2">
                <div class="col-sm-12 pl-0">
                    ...
                    <div class="col-sm-4 mt-1 d-none">
                        <div class="input-group">
                            <div class="input-group-prepend">
                                <span class="input-group-text" style="width:130px;height: 35px;" id="inputGroup-sizing-default">RETURN RS:</span>
                            </div>
                            <input type="number" style="height: 35px;" class="form-control"  name="return" id="return" value="0">
                    ...
                    <div style="height: 35px;" class="btn-group mb-3 mt-2" role="group" aria-label="Basic example">
                        ...
                        <button type="button" class="btn btn-sm btn-success" id="save_dev"><span class="fa fa-bookmark mr-2"></span>SAVE QUOTATION</button>
       ...
       <!-- Modal view-->
        ...
        <div class="modal fade" id="myModal3" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
            <div class="modal-dialog modal-dialog-centered" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="exampleModalLongTitle" >Set Transport Amount</h5>
                        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                            <span aria-hidden="true">&times;</span>
                        </button>
                    </div>
                    <div class="modal-body ">
                        <div class="row " >
                            <div class="col-sm-12 mt-1">
                                <div class="input-group-append">
                                    <div class="mr-2">
                                        <div class="input-group">
                                            <div class="input-group-prepend">
                                                <span class="input-group-text" style="width:130px;" id="inputGroup-sizing-default">TRANSPORT RS:</span>
                                            </div>
                                            <input type="number" class="form-control" style="width:320px;" name="trans_amount" id="trans_amount" onload="">
                                        </div>
                                    </div>
                            ...
                            <div class="col-sm-12 mt-2">
                                <button class="btn btn-info" id="do_credit">OK</button>
                            </div>
                                ...
                                <div class="input-group-append mt-1">
                                    <div class="mr-2">
                                        <div class="input-group">
                                            ...
                                            <input type="number" class="form-control" style="width:320px;" name="trans_amount_c" id="trans_amount_c" onload="">
                                        </div>
                                    </div>
                               ...
                               <form action="" method="post">
                                <div class="card-body">
                                    ...
                                    <div class="mr-2">
                                        <div class="input-group">
                                            <div class="input-group-prepend">
                                                <span class="input-group-text" style="width:150px;" id="inputGroup-sizing-default">Branch:</span>
                                            </div>
                                    ...
                                    <div class="mr-2">
                                        <div class="input-group">
                                            <div class="input-group-prepend">
                                                <span class="input-group-text" style="width:150px;" id="inputGroup-sizing-default">Transport:</span>
                                            </div>
        ...
        <script type="text/javascript">
            ...
            function getItemStock(ID){
                 var dataString ='hash='+ItemID ;
                    ...
                    $.ajax({
                        url: 'getItemStockServletEmptyQty',
                        dataType: "json",
                        data: dataString,
                        cache: false,
            ...
            function onAddPress(){
                        ...
                        if (ItemID == 0 || qty == 0 || price == 0){
                            ...
                            swal("PLEASE SET ITEM DISCOUNT AND QTY FIRST !").then((value) => {
                                    ...
                                    $.ajax({
                                    url: 'setInvoiceServletWithoutQtyCheck',
                                            data: {
                                                    itemID: ItemID,
                                                    stockid: StockID,
                                                    qty: qty,
                                     ...
                                     success: function (data) {
                                        ...
                                        if (data === "1") {
                                            swal({
                                                ...
                                                text: "do you want to print Quotationce now ? ",
                                                icon: "warning",
                                                buttons: true,
                                                dangerMode: true,
                                            }).then((willDelete) =>{
                                                if(willDelete){
                                                        location.reload();
                                                        popupWindow = window.open('printquatation.jsp?q='+id,'popUpWindow','height='+screen.availHeight+',width='+screen.availWidth+',left=100,top=100,resizable=yes,scrollbars=yes,toolbar=yes,menubar=no,location=no,directories=no, status=yes');
                                                
                                                        //window.open('printquatation.jsp?q='+id, '_blank');
                                                }else{
                                                        swal({
                                                            title: "QUOTATION SAVED!",
                                                            text: "Quotation saved  !",
                                                            icon: "success",
                                                            button: "OK"
                                                            }).then((value) => {
                                                                location.reload();
                                              ...
                                              swal({
                                                title: "Empty Quotation Data!",
                                                text: "can't get Quotation data. please retry !",
                                                icon: "error",
                                                button: "OK"
                                            }).then((value) => {
                                                location.reload();
