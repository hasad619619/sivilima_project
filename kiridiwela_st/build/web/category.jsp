            ...
            <div class="row mt-5">
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active" style="font-size: 16px;" aria-current="page">Category</li>
                    </ol>
                </nav>
            </div>
                        ...
                        <table id="table1" class="table table-active">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <button class="btn btn-warning btn-sm delete_dev" id="delete_dev"  value="<%=DE.getIdcategory() %>">Delete | Reset</button>
                                        ...
                                        <button  class="btn btn-info btn-sm update_dev"  id="update_dev" value="<%=DE.getIdcategory()%>">Update</button>
                            ...
                            <div class="row">
                                ...
                                <div class="card-body">
                                    <div class="form-inline">
                                        <label for="inputEmail3" class="col-md-2 control-label">Category Name:</label>

                                            <input type="text" class="form-control col-md-7 mr-1" id="inputEmail3" placeholder="Category name" name="ename" id="ename">
                            ...
                            <form action="" method="post">
                                <div class="card-body">
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-10">
                                            <input type="text" class="form-control" id="col_1" placeholder="Catgory name" name="col_1" >
                                        </div>
                                    </div>
            ...
            dangerMode: true,
                    ...
                    if (willDelete) {
                        ...
                        if (data === "1") {
                            ...
                            swal({
                                title: "Good job!",
                                text: "you update Category from list !",
                                icon: "success",
                                button: "OK"
                            }).then((value) => {
                                    location.reload();
