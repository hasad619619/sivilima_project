            ...
            <div class="row mt-5">
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active" style="font-size: 16px;" aria-current="page">Employee Cash Release</li>
                        ...
                        <table class="table table-light " id="tbl1">
                            <thead>
                                <tr>
                                    ...
                                    <th style="background-color: #10ac84 !important; color: white !important; ">Paytype</th>
                                   ...
                                   if ( Date != "" && Date2 != "") {
                                    ...
                                    if (de.size() > 0) {
                                        for (PurchusInvoiceRecipt DE : de) {
                                            if(DE.getAccountBySupplier().getEmployee() == 1){
