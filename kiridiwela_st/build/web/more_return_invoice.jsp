            ...
            <div class="row mt-5">
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active" style="font-size: 16px;" aria-current="page">Sales Return Details</li>
                ...
                <div class="card col-md-12" style="box-shadow: 0 4px 8px 0 rgba(0, 0, 0, 0.2), 0 6px 20px 0 rgba(0, 0, 0, 0.19);">
                    <div class="card-body">
                        <table class="table table-light " id="tbl1">
                            <thead>
                                <tr>
                                    <th style="background-color: #10ac84 !important; color: white !important; " id="dev_id" class="dev_id" >Return invoice id</th>
                            ...
                            <tbody>
                                <%                                    
                                    if (Date != "" && Date2 != ""){
                                        ...
                                        List<SalesReturn> de = cr.list();
                                        
                                        if (de.size() > 0) {
                                            for (SalesReturn DE : de) {
                                            if(branch > 0){
                                                
                                                String NAME = "";    
                                                boolean flag=false; 
                                            Set<SalesReturnItems> IT = DE.getSalesReturnItemses();
                                            for(SalesReturnItems N:IT){
                                                NAME = N.getSaleInvoiceItem().getSaleInvoice().getAccount().getName();
                                                if(N.getSaleInvoiceItem().getSaleInvoice().getBranch().getIdbranch() == branch){
                                                    flag = true; 
                                                }
                                            }
