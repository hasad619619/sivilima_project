            ...
            <div class="row mt-5">
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active" style="font-size: 16px;" aria-current="page">Received Cheque Payment</li>
                        ...
                        <table class="table table-light " id="tbl1">
                            <thead>
                                <tr>
                                    ...
                                    <th style="background-color: #10ac84 !important; color: white !important; ">cheque number</th>
                                    <th style="background-color: #10ac84 !important; color: white !important; ">cheque Date</th>
                                    <th style="background-color: #10ac84 !important; color: white !important; ">Bank</th>
                                            ...
                                            if(branch==DE.getBranch().getIdbranch()){
                                                ...
                                                %>
                                                    <tr>
                                                        ...
                                                        <td><%=DE.getCheDate() %></td>
                                                         <td><%=DE.getBank()+"  "+DE.getBranch().getName() %></td>
