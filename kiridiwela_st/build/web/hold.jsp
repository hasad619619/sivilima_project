                ...
                <div class="col-sm-12 pl-0">
                    ...
                    <div class="col-sm-4 mt-1">
                        <div class="input-group">
                            ...
                            <input style="height: 35px;" type="number" class="form-control" value="<%= grandprofit %>"  disabled="" name="netprofit2" id="netprofit2" >
                    ...
                    <div class="col-sm-4 mt-1">
                        <div class="input-group">
                            <div class="input-group-prepend">
                                <span class="input-group-text" style="width:131px;height: 35px;" id="inputGroup-sizing-default">DELIVER DATE:</span>
                            </div>
                            <input style="height: 35px;" type="date" class="form-control"  name="dd" id="dd" >
                            
                        </div>
                    </div>
                    <div style="height: 35px;" class="btn-group mb-3 mt-2" role="group" aria-label="Basic example">
                                    
                        <button type="button" class="btn btn-sm btn-success" id="save_dev"><span class="fa fa-bookmark mr-2"></span>HOLD</button>
       ...
       <!-- Modal view-->
        ...
        <script type="text/javascript">
                    ...
                    url: 'getItemNameServlet2',
                            ...
                            getItemStock(ItemID);
                                    ...
                                    ItemID=0;
                                     ...
                                     swal("PLEASE ENTER VALID  ITEM ID ! !");
                            }
           ...
           function befourSave(){
                ...
                if(dd==''){
                    swal({
                                                title: "Select Delevery Date First !",
                                                text: "can't get delevery date please set delevery date !",
                                                icon: "error",
                                                button: "OK"
                                            }).then((value) => {
                                                $('#dd').focus();
