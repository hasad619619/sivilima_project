        ...
        <main role="main" class="container">
            <div class="row mt-5">
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active" aria-current="page">Damage Stock Analysis By Supplier</li>
                    </ol>
                </nav>
            </div>
            ...
            <div class="row mt-2">
                <div class="card col-md-12" style="box-shadow: 0 4px 8px 0 rgba(0, 0, 0, 0.2), 0 6px 20px 0 rgba(0, 0, 0, 0.19);">
                    <div class="card-body">
                        <form method="get" action="damagestockanalys.jsp" >
                            <div class="row">
                                <div class="col-md-4">
                                ...
                                <%                                    
                                    ...
                                    if (de.size() > 0) {
                                        ...
                                        if(branch > 0 && account ==0){
                                            ...
                                            if(account==DE.getStock().getItems().getAccount().getIdaccount()){
                                             total_qty=total_qty+DE.getQty();
                                            ...
                                            if(account==DE.getStock().getItems().getAccount().getIdaccount() && branch==DE.getBranch().getIdbranch() ){
                                                 total_qty=total_qty+DE.getQty();
