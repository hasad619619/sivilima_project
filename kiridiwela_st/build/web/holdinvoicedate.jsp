...
<html lang="en">
    ...
    <body>
            ...
            <div class="row mt-5">
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active" aria-current="page">Hold Invoice Details (Date)</li>
                    </ol>
                </nav>
            </div>
            <div class="row mt-2">
                <div class="card col-md-12" style="box-shadow: 0 4px 8px 0 rgba(0, 0, 0, 0.2), 0 6px 20px 0 rgba(0, 0, 0, 0.19);">
                    <div class="card-body">
                        <form method="get" action="holdinvoicedate.jsp" >
                            <div class="row">
                                <div class="col-md-4">
                        ...
                        <table class="table table-light" id="tbl1">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td><%= "ACTIVE" %></td>
                                    <td>
                                        <a type="submit" class="btn btn-success btn-sm" href="holdprint.jsp?pid=<%=ir.getIdholdInvoice()%>" >VIEW</a>
                                        <%
                                            if(ir.getStatus() == 1){
                                            %>
                                        <a type="submit" class="btn btn-danger btn-sm" href="setReturnHoldInvoice?q=<%=ir.getIdholdInvoice()%>" >EDIT</a>
                                        <%
                                            }
                                            %>
                                    </td>
        ...
        <script type="text/javascript">
            ...
            document.getElementById('D').innerHTML="RS "+ <%=total_return %>;
