            ...
            <div class="row mt-5">
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active" aria-current="page">Sales Details (Date)</li>
                    </ol>
                </nav>
            </div>
            <div class="row mt-2">
                <div class="card col-md-12" style="box-shadow: 0 4px 8px 0 rgba(0, 0, 0, 0.2), 0 6px 20px 0 rgba(0, 0, 0, 0.19);">
                    <div class="card-body">
                        <form method="get" action="salesanalyse.jsp" >
                            <div class="row">
                                <div class="col-md-4">
                    ...
                    <div class="card-body">
                        <table class="table table-light" id="tbl1">
                            ...
                            <tbody>
                                ...
                                %>
                                <tr>
                                    <td><%=ir.getIdsaleInvoice() %></td>
                                    <td><%=ir.getAccount().getName() %></td>
                                    <td><%= ir.getPaymentType().getName() %></td>
                                    <td><%= ir.getTotal() %></td>
                                    <td><%= ir.getTotalCost() %></td>
                                    <td><%= ir.getTotalProfit() %></td>
                                    <td><%= ir.getPaid() %></td>
                                    <td><%= ir.getPaible() %></td>
                                    <td>
                                        <a type="submit" class="btn btn-success btn-sm" href="invoiceeprint.jsp?pid=<%=ir.getIdsaleInvoice() %>" >PRINT</a>
