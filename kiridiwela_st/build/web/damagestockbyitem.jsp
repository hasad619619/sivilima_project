    ...
    <body>
        ...
        <main role="main" class="container">
            <div class="row mt-5">
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active" aria-current="page">Damage Stock Analysis By Item</li>
                    </ol>
                </nav>
            </div>
            ...
            <div class="row mt-2">
                <div class="card col-md-12" style="box-shadow: 0 4px 8px 0 rgba(0, 0, 0, 0.2), 0 6px 20px 0 rgba(0, 0, 0, 0.19);">
                    <div class="card-body">
                        <form method="get" action="damagestockbyitem.jsp" >
                            <div class="row">
                                <div class="col-md-4">
            ...
            <div class="row mt-2">
                <div class="card col-md-12" style="box-shadow: 0 4px 8px 0 rgba(0, 0, 0, 0.2), 0 6px 20px 0 rgba(0, 0, 0, 0.19);">
                    <div class="card-body">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <h6 id="EA">Item Name: <%= AccountN %></h6>    
                    ...
                    <div class="card-body">
                        <table id="table1" class="table">
                            ...
                            <tbody>
                                <%                                    
                                     if ( Date != "" && Date2 != "") {
                                    Criteria cr1 = ses.createCriteria(StockDamage.class);
                                    cr1.add(Restrictions.between("date", Date, Date2));
                                    ...
                                    if (de.size() > 0) {
                                        ...
                                        if(branch > 0 && account ==0){
                                            if(branch==DE.getBranch().getIdbranch()){
                                                total_qty=total_qty+DE.getQty();
                                                QTY=DE.getStock().getItems().getType().getName();
                                                %>
                                                    <tr>

                                                        <td><%=DE.getStockDamageId()%></td>
                                                        <td><%=DE.getDate()%></td>
                                            ...
                                            if(account==DE.getStock().getItems().getItemId()){
                                             total_qty=total_qty+DE.getQty();
                                             QTY=DE.getStock().getItems().getType().getName();  
                                            ...
                                            if(account == DE.getStock().getItems().getItemId()  && branch==DE.getBranch().getIdbranch() ){
                                                 total_qty=total_qty+DE.getQty();
                                                 QTY=DE.getStock().getItems().getType().getName();
        ...
        <script type="text/javascript">
            ...
            if(acc === '0' || acc === 0){
                 ...
                 document.getElementById('A').innerHTML="Total Damaged Quantity: "+ <%=total_qty %>;
