    ...
    <body>
        ...
        <%
            ...
            if (request.getParameter("pid") != null && !request.getParameter("pid").equals("")) {
                ...
                PayExpencess pi = (PayExpencess) ses.load(PayExpencess.class, Integer.parseInt(request.getParameter("pid").toString()));
                if (pi != null) {
                    

        %>
        <img src="logoimage/<%=pi.getUser().getBranch().getExpensesHeader() %>" style="width: 100% !important;" />
                    ...
                    <div class="col-sm-6">
                        <table>
                            <tr>
                                ...
                                <td>&nbsp;<%= pi.getAddedDate() %></td>
                            </tr>
                            <tr>
                                <td><p class="mb-0">Expenses Account :</p></td>
                                <td>&nbsp;<%= pi.getExpencessAccount().getName()%></td>
                            </tr>
                            <tr>
                                <td><p class="mb-0">Receipt ID:</p></td>
                                <td>&nbsp;<%= pi.getIdpayExpencess() %></td>
                            </tr>
                            <tr>
            ...
            <div class="row mt-2">
                ...
                <table class="table table-sm table-bordered">
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td style="border: #2d3436 solid 1px !important;"><%= "CASH FOR " + pi.getRemark() %></td>
                            <td style="border: #2d3436 solid 1px !important;"><%= df.format(pi.getAmount())%> </td>
                            <td style="border: #2d3436 solid 1px !important;"><%=pi.getAddedDate() + "  " + pi.getAddedTime() %></td>
        ...
        <img src="logoimage/<%=pi.getUser().getBranch().getFooter()%>" style="width: 100% !important;position:fixed !important;bottom: 0px !important;" />
