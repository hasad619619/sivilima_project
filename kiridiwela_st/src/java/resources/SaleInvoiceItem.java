...
/**
 * SaleInvoiceItem generated by hbm2java
 */
public class SaleInvoiceItem  implements java.io.Serializable {
    ...
    public SaleInvoiceItem(Items items, SaleInvoice saleInvoice, Stock stock) {
        this.items = items;
        this.saleInvoice = saleInvoice;
        this.stock = stock;
    }
    public SaleInvoiceItem(Items items, SaleInvoice saleInvoice, Stock stock, Double qtt, Double unitPrice, Double descountRate, Double descount, Double total, Double netTotal, Integer status, Double cost, String nowType, String originalType, Double originalCostPerItem, Double originalQtt, String location, Double profit, Set salesReturnItemses) {
       this.items = items;
       this.saleInvoice = saleInvoice;
       this.stock = stock;
       this.qtt = qtt;
