...
/**
 * HoldRecipt generated by hbm2java
 */
public class HoldRecipt  implements java.io.Serializable {
    ...
    public HoldRecipt(Account accountByCustomer, Branch branch, HoldInvoice holdInvoice, PaymentType paymentType, User user) {
    ...
    public HoldRecipt(Account accountByBankAccount, Account accountByCustomer, Branch branch, HoldInvoice holdInvoice, PaymentType paymentType, User user, Double amount, String cheNumber, String cheRegDate, String cheDate, Double cheAmount, Integer status, Integer cheStatus, String date, String chequeBranch, String remarks, String bank, String time) {
