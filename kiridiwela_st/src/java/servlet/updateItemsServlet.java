                            ...
                            if (item.isFormField()) {
                                switch (item.getFieldName()) {
                                    ...
                                    case "h":
                                        ...
                                        break;
                                    case "iid":
                                        IID = Integer.parseInt(item.getString());
                                        break;
                                    default:
                                        break;
                                }
                            ...
                            //todo file upoad
                            {
                                if (false) {
                                    ...
                                    if (L.size() > 1) {
                                        ...
                                        Items ad = (Items) ses.load(Items.class, IID);
                                        ad.setName(name);
                                        ...
                                        tr.commit();
                                        ses.close();
                                        response.sendRedirect("updateitem.jsp?q=1&i="+ad.getItemId());

                                    } else {
                                        response.sendRedirect("updateitem.jsp?q=0&i="+IID);
                                    }
