 ...
 */
@WebServlet(name = "saveEmployeeAccountServlet", urlPatterns = {"/saveEmployeeAccountServlet"})
public class saveEmployeeAccountServlet extends HttpServlet {
            ...
            if (request.getSession().getAttribute("administrator") != null) {
                ...
                if (admin.getLevel() == 1 || admin.getLevel() == 2) {
                    ...
                    if (name.equals("")) {
                        ...
                        EmployeeAccount ad = new EmployeeAccount();
                        ad.setName(name);
                        ad.setStatus(1);
