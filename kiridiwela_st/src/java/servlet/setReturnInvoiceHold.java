 ...
 */
@WebServlet(name = "setReturnInvoiceHold", urlPatterns = {"/setReturnInvoiceHold"})
public class setReturnInvoiceHold extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            response.sendRedirect("deliveryreturn.jsp?q=" + ID);
        }
    }
