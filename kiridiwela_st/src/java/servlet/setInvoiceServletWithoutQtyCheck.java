 ...
 */
@WebServlet(name = "setInvoiceServletWithoutQtyCheck", urlPatterns = {"/setInvoiceServletWithoutQtyCheck"})
public class setInvoiceServletWithoutQtyCheck extends HttpServlet {
