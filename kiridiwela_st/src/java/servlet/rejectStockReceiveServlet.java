 ...
 */
@WebServlet(name = "rejectStockReceiveServlet", urlPatterns = {"/rejectStockReceiveServlet"})
public class rejectStockReceiveServlet extends HttpServlet {
        ...
        try {
            if (request.getParameter("id") != null && !request.getParameter("id").equals("") && !request.getParameter("id").equals("0")) {
                ...
                if (ST.getStatus() == 2) {
                    ...
                    ST.setRequestQty(ST.getSendQty());
                    ses.update(ST);
                    out.print("1");
                } else {
                    out.print("3");                    
