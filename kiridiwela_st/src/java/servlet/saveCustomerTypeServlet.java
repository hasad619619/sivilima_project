 ...
 */
@WebServlet(name = "saveCustomerTypeServlet", urlPatterns = {"/saveCustomerTypeServlet"})
public class saveCustomerTypeServlet extends HttpServlet {
            ...
            if (request.getSession().getAttribute("administrator") != null) {
                ...
                if (admin.getLevel() == 1 || admin.getLevel() == 2) {
                    ...
                    if (name.equals("")) {
                        ...
                        CustomerType ad = new CustomerType();
