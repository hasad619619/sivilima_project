 ...
 */
@WebServlet(name = "saveReturnInvoiceServlet", urlPatterns = {"/saveReturnInvoiceServlet"})
public class saveReturnInvoiceServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            if (request.getSession().getAttribute("invoiceReturn") != null) {
                ArrayList<invoiceReturnModel> invoice = (ArrayList<invoiceReturnModel>) request.getSession().getAttribute("invoiceReturn");

                Session ses2 = connection.getConnection.getSessionFactory().openSession();
                Transaction tr2 = ses2.beginTransaction();

                double tot = 0.0;
                String REMARK = "RETURN";
                ...
                if (tot > 0.0) {
                    ...
                    for (invoiceReturnModel IRM : invoice) {
                        ...
                        RI.setItems(IT);
                        SaleInvoiceItem SII = (SaleInvoiceItem) ses2.load(SaleInvoiceItem.class, IRM.getInvoice_id());
                    ...
                    out.print("1-" + SR.getIdsalesReturn());
