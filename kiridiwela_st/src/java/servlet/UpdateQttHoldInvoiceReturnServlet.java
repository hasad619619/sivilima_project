 ...
 */
@WebServlet(name = "UpdateQttHoldInvoiceReturnServlet", urlPatterns = {"/UpdateQttHoldInvoiceReturnServlet"})
public class UpdateQttHoldInvoiceReturnServlet extends HttpServlet {
