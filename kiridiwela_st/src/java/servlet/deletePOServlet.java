 ...
 */
@WebServlet(name = "deletePOServlet", urlPatterns = {"/deletePOServlet"})
        ...
        if (admin != null) {
            ...
            if (admin.getLevel() == 1) {
                ...
                if (id.equals("")) {
                    ...
                    PurchaseInvoiceOrder de = (PurchaseInvoiceOrder) ses.load(PurchaseInvoiceOrder.class, Integer.parseInt(id));
                    int s = de.getStatus();
                    if (s == 1) {
                        de.setStatus(0);
                    } else {
