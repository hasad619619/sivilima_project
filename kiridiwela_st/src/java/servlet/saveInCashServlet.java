 ...
 */
@WebServlet(name = "saveInCashServlet", urlPatterns = {"/saveInCashServlet"})
public class saveInCashServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            if (request.getParameter("payment").equals("") || request.getParameter("desc").equals("") || request.getParameter("trans").equals("") || request.getParameter("ret").equals("") || request.getSession().getAttribute("i1") == null || request.getSession().getAttribute("invoiceS") == null) {
