 ...
 */
@WebServlet(name = "saveThirdCategoryServlet", urlPatterns = {"/saveThirdCategoryServlet"})
public class saveThirdCategoryServlet extends HttpServlet {
            ...
            if (request.getSession().getAttribute("administrator") != null) {
                ...
                if (admin.getLevel() == 1 || admin.getLevel() == 2) {
                    ...
                    if (request.getParameter("name") == null || request.getParameter("name").equals("") || request.getParameter("sct") == null) {
                        ...
                        ThirdCategory ad = new ThirdCategory();
