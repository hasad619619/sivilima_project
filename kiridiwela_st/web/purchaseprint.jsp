        ...
        <div class="container print">
            <%  
                ...
                if (request.getParameter("pid") != null && !request.getParameter("pid").equals("") ) {
                    ...
                    PurchusInvoice pi = (PurchusInvoice) ses.load(PurchusInvoice.class, Integer.parseInt(request.getParameter("pid").toString()));
                    if (pi != null) {

            %>
            <div class="row">
                <div class="col-sm-12">
                    <center><h2>N.O.H</h2></center>
                    <div class="col-sm-6">
                        <h2>INVOICE</h2>
                        <table>
                            <tr>
                            ...
                            <tr>
                                <td><p class="mb-0">PO Number | Date :</p></td>
                                <td>&nbsp;<%= pi.getPurchaseInvoiceOrder().getIdpurchaseInvoiceOrder() +" | "+pi.getDate() %></td>
                            </tr>
                            <tr>
            ...
            <div class="row mt-2">
                ...
                <table class="table table-sm table-bordered">
                    ...
                    <tbody>
                        <%
                            Set<PurchusInvoiceItem> pii = pi.getPurchusInvoiceItems();
                            for (PurchusInvoiceItem PII : pii) {

                        %>
                        <tr>
                            <td><%=PII.getItems().getItemId()%></td>
                            <td><%=PII.getItems().getName()%></td>
                            <td class="text-right"><%= PII.getQtt() + " " + PII.getItems().getType().getName()%> </td>
                            <td class="text-right"><%=PII.getUnitPrice() + "  RS"%></td>
                            <td class="text-right"><%=PII.getNetTotal() + "  RS"%></td>
                        </tr>
                        <%
                            }
