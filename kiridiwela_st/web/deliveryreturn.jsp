...
<html lang="en">
    ...
    <body>
        ...
        <main role="main" class="container"  >
            ...
            <div class="row mt-1">
                <form action="setReturnInvoiceHold" method="get">
            ...
            <%
                ...
                if (request.getSession().getAttribute("invoiceReturnHold") != null && request.getParameter("q") != null && !request.getParameter("q").equals("")) {
            ...
            <div class="row mt-2">
                <div class="card col-md-12">
                    <div class="card-body">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <h6>Hold Invoice ID:<span id="F"><%= SI.getIdholdInvoice()%></span></h6>    
                ...
                <table class="table table-sm  table-bordered" >
                    <thead>
                        <tr>
                            ...
                            <th style="background-color:#10ac84 !important; color: white !important; ">DESC.</th>
        ...
        <script type="text/javascript">
            ...
            $('.btn_up_qtt').click(function (e) {
                    ...
                    if(qtt=='' || qtt == 0|| qtt < 0){
                        ...
                        $.ajax({
                            url: 'UpdateQttHoldInvoiceReturnNewServlet',
                            data: {
                            hash:hash,
                            qty:qtt
            ...
            $('.remove').click(function (e) {
                    ...
                    var hash = $(this).closest('tr').find('.remove').val();
                    $.ajax({
                    url: 'RemoveInvoiceReturnHoldServlet',
                            data: {
                            hash:hash
           ...
           function save(){
                    ...
                    if(rtt== ''){
                        rtt="N/A";
                             ...
                             $.ajax({
                             url: 'saveReturnInvoiceHoldServlet',
                                     data: {
                                     ac: aco,
                                     inv: invo,
                                     r:rtt
