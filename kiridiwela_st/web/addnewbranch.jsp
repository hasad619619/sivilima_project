    ...
    <body>
            ...
            <div class="row mt-5">
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active" style="font-size: 16px;" aria-current="page">Add new branch</li>
                    </ol>
                </nav>
            </div>
            <div class="row mt-2">
                    ...
                    <div class="card-body">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                ...
                                <img src="images/br.gif" class="col-md-12"  >
        ...
        <script type="text/javascript">
            ...
            url: 'saveBranchServlet',
                    ...
                    swal({
                    title: "Good job!",
                            text: "you just create new branch !",
                            icon: "success",
                            button: "OK"
                    }).then((value) =>{
