...
<html lang="en">
            ...
            <div class="row mt-5">
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active" style="font-size: 16px;" aria-current="page">Brand</li>
                    </ol>
                </nav>
            </div>
                        ...
                        <table id="table1" class="table">
                            ...
                            <thead>
                                <tr style="background-color: #10ac84 !important; color: white !important; ">
                                    <th id="dev_id" class="dev_id" >Brand ID</th>
                                    <th>name</th>
                                    <th>status</th>
                                    <th>option</th>
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <button class="btn btn-warning btn-sm delete_dev" id="delete_dev"  value="<%=DE.getIdbrand()%>">Delete | Reset</button>
                                        ...
                                        <button  class="btn btn-info btn-sm update_dev"  id="update_dev" value="<%=DE.getIdbrand()%>">Update</button>
                            ...
                            <div class="row">
                                ...
                                <div class="card-body">
                                    <div class="form-inline">
                                        <label for="inputEmail3" class="col-md-2 control-label">Brand Name:</label>

                                            <input type="text" class="form-control col-md-7 mr-1" id="inputEmail3" placeholder="Brand name" name="ename" id="ename">
                            ...
                            <form action="" method="post">
                                <div class="card-body">
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-10">
                                            <input type="text" class="form-control" id="col_1" placeholder="brand name" name="col_1" >
                                        </div>
                                    </div>
    ...
    $(".update_model").click(function () {
        ...
        swal({
            title: "Are you sure?",
            text: "do you want to update Brand details? ",
            icon: "warning",
            buttons: true,
            dangerMode: true,
            }).then((willDelete) => {
                    if (willDelete) {
                        ...
                        if (data === "1") {
                            ...
                            swal({
                                title: "Good job!",
                                text: "you update Brand from list !",
                                icon: "success",
                                button: "OK"
                            }).then((value) => {
                                    location.reload();
    ...
    $(".delete_dev").click(function () {
        ...
        swal({
            title: "Are you sure?",
            text: "do you want to "+name+ " Brand ? ",
            icon: "warning",
            buttons: true,
            dangerMode: true,
            }).then((willDelete) => {
        ...
        $.ajax({
            ...
            success: function (data) {
                if (data === "1") {
                    ...
                    swal({
                                title: "Good job!",
                                text: "you add new brand to list !",
                                icon: "success",
                                button: "OK"
                            }).then((value) => {
                                    location.reload();
