            ...
            <div class="row mt-5">
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active" style="font-size: 16px;" aria-current="page">Customer Category Setup</li>
                    </ol>
                </nav>
            </div>
                        ...
                        <table id="table1" class="table table-active table-sm">
                            ...
                            <thead>
                                <tr style="background-color: #10ac84 !important; color: white !important; ">
                                    <th id="dev_id" class="dev_id" >Customer Type ID</th>
                                    <th>name</th>
                                    <th>status</th>
                                    <th>option</th>
                            ...
                            <tbody>
                                <%
                                    ...
                                    Criteria cr = ses.createCriteria(CustomerType.class);
                                    List<CustomerType> de = cr.list();
                                    
                                    
                                    if (de.size() > 0) {
                                        for ( CustomerType DE : de) {


                                %>
                                <tr>
                                    <td><%=DE.getCustomerTypeId()%></td>
                                    <td><%=DE.getName() %></td>
                                    ...
                                    <td>
                                        <button class="btn btn-warning btn-sm delete_dev" id="delete_dev"  value="<%=DE.getCustomerTypeId() %>">Delete | Reset</button>
                                        ...
                                        <button  class="btn btn-info btn-sm update_dev"  id="update_dev" value="<%=DE.getCustomerTypeId()%>">Update</button>
                            ...
                            <div class="row">
                                ...
                                <div class="card-body">
                                    <div class="form-inline">
                                        <label for="inputEmail3" class="col-md-2 control-label">Customer Type:</label>

                                            <input type="text" class="form-control col-md-7 mr-1" id="inputEmail3" placeholder="Customer type name" name="ename" id="ename">
  ...
  <div class="modal fade" id="myModal" role="dialog" aria-hidden="true">
    <div class="modal-dialog">
      ...
      <div class="modal-content">
        <div class="modal-header">
          <h5 class="modal-title">Update Customer Type Details</h5>
   ...
   $(window).load(function(){
    ...
    $(".update_model").click(function () {
        ...
        swal({
            title: "Are you sure?",
            text: "do you want to update Customer Type details? ",
            icon: "warning",
            buttons: true,
            dangerMode: true,
            }).then((willDelete) => {
                    if (willDelete) {
                        ...
                        if (data === "1") {
                            ...
                            swal({
                                title: "Good job!",
                                text: "you update Customer Type from list !",
                                icon: "success",
                                button: "OK"
                            }).then((value) => {
                                    location.reload();
    ...
    $(".delete_dev").click(function () {
        ...
        swal({
            title: "Are you sure?",
            text: "do you want to "+name+ " Customer Type ? ",
            icon: "warning",
            buttons: true,
            dangerMode: true,
            }).then((willDelete) => {
                    if (willDelete) {
                        ...
                        if (data === "1") {
                            ...
                            swal({
                                title: "Good job!",
                                text: "you "+name+ " Customer Type from list !",
                                icon: "success",
                                button: "OK"
                            }).then((value) => {
        ...
        $.ajax({
            ...
            success: function (data) {
                if (data === "1") {
                    ...
                    swal({
                                title: "Good job!",
                                text: "you add new Customer Type to list !",
                                icon: "success",
                                button: "OK"
                            }).then((value) => {
                                    location.reload();
