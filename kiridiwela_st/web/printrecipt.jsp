    ...
    <body>
        ...
        <%
            ...
            if (request.getParameter("pid") != null && !request.getParameter("pid").equals("")) {
                ...
                InvoiceRecipt pi = (InvoiceRecipt) ses.load(InvoiceRecipt.class, Integer.parseInt(request.getParameter("pid").toString()));
                if (pi != null) {
                    if (pi.getAccountByBankAccount() != null) {
                        NAME = pi.getAccountByBankAccount().getName();
                    }

        %>
        <% if (pi.getPaymentType().getIdpaymentType() == 2) {%>
        <img src="logoimage/<%=pi.getBranch().getReceiveCash()%>" style="width: 100% !important;" />  
        <% } else if (pi.getPaymentType().getIdpaymentType() == 3) {%> 
        <img src="logoimage/<%=pi.getBranch().getReceiveChe()%>" style="width: 100% !important;" />  
        <% } else if (pi.getPaymentType().getIdpaymentType() == 4) {%> 
        <img src="logoimage/<%=pi.getBranch().getReceiveBank()%>" style="width: 100% !important;" />
        ...
        <div class="container print p-5">
                    ...
                    <div class="col-sm-6">
                        <table>
                            ...
                            <tr>
                                ...
                                <td>&nbsp;<%= pi.getAccountByCustomer().getName()%></td>
                            </tr>
                            <tr>
            ...
            <div class="row mt-2">
                <%
                    if (pi.getPaymentType().getIdpaymentType() == 2 || pi.getPaymentType().getIdpaymentType() == 4) {
                %>
                ...
                <table class="table table-sm table-bordered">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td style="border: #2d3436 solid 1px !important;"><%=pi.getBank()%></td>
