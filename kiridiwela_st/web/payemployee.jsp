            ...
            <div class="row mt-5">
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active" style="font-size: 16px;" aria-current="page">Release Employee Payment</li>
                                ...
                                <div class="input-group mb-3">
                                    ...
                                    <select class="form-control sp" style="width:400px ;" id="account" name="account">
                                        ...
                                        <%
                                            ...
                                            Criteria cust = Hses.createCriteria(EmployeeAccount.class);
                                            cust.add(Restrictions.eq("status", 1));
                                            List<EmployeeAccount> customerList = cust.list();
                                            for (EmployeeAccount CL : customerList) {
                                                if(CL.getBranch().getName().equalsIgnoreCase(USER.getBranch())){
                                        %>
                                        <option value="<%=CL.getIdemployeeAccount()%>"><%=CL.getName()%></option>
                                     ...
                                     success: function (data) {
                                        ...
                                        if (data === "1") {
                                            ...
                                            swal({
                                                ...
                                                if(willDelete){
                                                        location.reload();
                                                        popupWindow = window.open('printemployeerecipt.jsp?pid='+id,'popUpWindow','height='+screen.availHeight+',width='+screen.availWidth+',left=100,top=100,resizable=yes,scrollbars=yes,toolbar=yes,menubar=no,location=no,directories=no, status=yes');
