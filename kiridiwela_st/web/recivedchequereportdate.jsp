...
<html lang="en">
    ...
    <body>
        ...
        <main role="main" class="container">
            ...
            <div class="row mt-5">
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active" aria-current="page">Received Cheque Proccesign Reports By Cheque Date</li>
                    </ol>
                </nav>
            </div>
            ...
            <div class="row mt-2">
                <div class="card col-md-12" style="box-shadow: 0 4px 8px 0 rgba(0, 0, 0, 0.2), 0 6px 20px 0 rgba(0, 0, 0, 0.19);">
                    <div class="card-body">
                        <form method="get" action="recivedchequereportdate.jsp" >
                            <div class="row">
                                <div class="col-md-4">
                                ...
                                <div class="col-md-4">
                                    ...
                                    <div class="input-group mb-3">
                                        ...
                                        <select class="form-control" name="ty" id="ty"  >
                                           ...
                                           <option value="3">PAID TO THIRD PARTY</option>
                ...
                <div class="card col-md-12" style="box-shadow: 0 4px 8px 0 rgba(0, 0, 0, 0.2), 0 6px 20px 0 rgba(0, 0, 0, 0.19);">
                    <div class="card-body">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <h6 id="A">Total PD RS: </h6>    
                                <h6 id="B">Total Deposited To Bank RS: </h6>       
                                <h6 id="C">Total Third Party Paid RS: </h6>       
                                                     ...
                                                     %>
                                                        <tr>
                                                            ...
                                                            <td>
                                                                ...
                                                                <%if(DE.getCheStatus() == 2){
                                                                    %>
                                                                    <input name="i_cbank" id="i_cbank" type="hidden" value="<%=DE.getAccountByBankAccount().getName() %>">
                                                                    <%
                                                                }else{
                                                                    %>
            ...
            <div class="modal-dialog modal-lg" role="document">
              <div class="modal-content">
                <div class="modal-header">
                  <h5 class="modal-title">Received Cheque Details</h5>
        ...
        <script type="text/javascript">
            ...
            $('#A').html("Total PD RS:"+A);
            $('#B').html("Total Deposited To Bank RS:"+B);
            $('#C').html("Total Third Party Paid RS:"+C);
           ...
           $('.view_dev').click(function (){
            ...
            $(document).ready(function () {
                ...
                customize: function(win) {
                    ...
                    $(win.document.body).append('<h5>Total PD RS:'+A+'</h5>'); //after the table
                    $(win.document.body).append('<h5>Total Deposited To Bank RS:'+B+'</h5>'); //after the table
                    $(win.document.body).append('<h5>Total Third Party Paid RS:'+C+'</h5>'); //after the table
