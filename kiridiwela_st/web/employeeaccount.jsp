<%@page import="resources.EmployeeAccount"%>
...
<html lang="en">
            ...
            <div class="row mt-5">
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active" style="font-size: 16px;" aria-current="page">Create Employee Account</li>
                    </ol>
                </nav>
            </div>
                        ...
                        <table id="table1" class="table table-sm">
                            ...
                            <tbody>
                                <%
                                    ...
                                    Criteria cr = ses.createCriteria(EmployeeAccount.class);
                                    List<EmployeeAccount> de = cr.list();
                                    
                                    
                                    if (de.size() > 0) {
                                        for ( EmployeeAccount DE : de) {


                                %>
                                <tr>
                                    <td style="border: #636e72 solid 1px !important;"><%=DE.getIdemployeeAccount()%></td>
                                    ...
                                    <td style="border: #636e72 solid 1px !important;">
                                        <button class="btn btn-warning btn-sm delete_dev" id="delete_dev"  value="<%=DE.getIdemployeeAccount() %>">Delete | Reset</button>
                                        ...
                                        <button  class="btn btn-info btn-sm update_dev"  id="update_dev" value="<%=DE.getIdemployeeAccount() %>">Update</button>
        ...
        swal({
            ...
            dangerMode: true,
                    ...
                    if (willDelete) {
                        ...
                        $.ajax({
                        url: 'updateEmployeeAccountServlet',
                        data: {
                        id: id,
                        name:name,
        ...
        swal({
            ...
            dangerMode: true,
                    ...
                    if (willDelete) {
                        ...
                        $.ajax({
                        url: 'deleteEmployeeAccountServlet',
                        data: {
                        id: idd
    ...
    $("#save_dev").click(function () {
        ...
        $.ajax({
            url: 'saveEmployeeAccountServlet',
            data: {
