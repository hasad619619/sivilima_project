    ...
    <body>
        ...
        <%
            ...
            if (request.getParameter("pid") != null && !request.getParameter("pid").equals("")) {
                ...
                PayEmployee pi = (PayEmployee) ses.load(PayEmployee.class, Integer.parseInt(request.getParameter("pid").toString()));
                if (pi != null) {
                    

        %>
        <img src="logoimage/<%=pi.getUser().getBranch().getReleaseCash() %>" style="width: 100% !important;" />
                ...
                <div class="col-sm-12">
                    <div class="col-sm-6">
                        <table>
                            ...
                            <tr>
                                <td><p class="mb-0">Employee Account Name :</p></td>
                                <td>&nbsp;<%= pi.getEmployeeAccount().getName()%></td>
                            </tr>
                            <tr>
                                <td><p class="mb-0">Receipt ID:</p></td>
                                <td>&nbsp;<%= pi.getIdpayEmployee() %></td>
                            </tr>
                            <tr>
