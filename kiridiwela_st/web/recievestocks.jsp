...
<html lang="en">
    ...
    <body>
            ...
            <div class="row mt-5">
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active" style="font-size: 16px;" aria-current="page">Receive Stocks</li>
                    </ol>
                </nav>
            </div>
                        ...
                        <table id="table1" class="table table-active table-sm">
                            ...
                            <tbody>
                                <%
                                    ...
                                    cr.add(Restrictions.eq("status", 2));
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <button class="btn btn-warning btn-sm delete_dev" id="delete_dev" style="width: 75px !important; margin-bottom: 5px;"  value="<%=DE.getIdstockTransfer() %>">REJECT</button>
                                        <button class="btn btn-info btn-sm approve_dev" id="approve_dev" style="width: 75px !important; " value="<%=DE.getIdstockTransfer() %>">APPROVE</button>
                                        <input type="hidden" name="stat" id="stat" class="stat" value= "<%= DE.getStatus() %>"/>
                                        <input type="hidden" name="ite" id="ite" class="ite" value= "<%= DE.getStock().getStockId() %>"/>
                                    </td>
                                </tr>
     ...
     $(".approve_dev").click(function () {
         ...
         stock=$(this).closest('tr').find('input[name="ite"]').val();
         clickUse(stock);
     });
                        ...
                        if (data === "1") {
                            ...
                            swal({
                                ...
                                swal({
                                    ...
                                    text: "Not Enough qty found on you requested stock.",
                                    icon: "error",
                                    button: "OK"
                                });
