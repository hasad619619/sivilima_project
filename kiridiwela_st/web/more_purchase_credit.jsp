            ...
            <div class="row mt-5">
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active" style="font-size: 16px;" aria-current="page">Credit Purchase</li>
                            ...
                            <tbody>
                                <%                                    
                                   if ( Date != "" && Date2 != "") {
                                    ...
                                    List<PurchusInvoice> de = cr.list();

                                    if (de.size() > 0) {
                                        for (PurchusInvoice DE : de) {
                                            if(DE.getPaible() > 0){
