            ...
            <div class="row mt-5">
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active" style="font-size: 16px;" aria-current="page">Credit Sales</li>
                ...
                <div class="card col-md-12" style="box-shadow: 0 4px 8px 0 rgba(0, 0, 0, 0.2), 0 6px 20px 0 rgba(0, 0, 0, 0.19);">
                    <div class="card-body">
                        <table class="table table-light " id="tbl1">
                            <thead>
                                <tr>
                                    <th style="background-color: #10ac84 !important; color: white !important; " id="dev_id" class="dev_id" >invoice id</th>
                                    ...
                                    <th style="background-color: #10ac84 !important; color: white !important; ">Credit Amount</th>
                            ...
                            <tbody>
                                <%                                    
                                   if ( Date != "" && Date2 != "") {
                                    ...
                                    List<SaleInvoice> de = cr.list();

                                    if (de.size() > 0) {
                                        for (SaleInvoice DE : de) {
                                            if(DE.getPaible() > 0 ){
                                        if(branch > 0 && account ==0){
                                            if(branch==DE.getBranch().getIdbranch()){
                                                
                                                if(DE.getPaymentType().getIdpaymentType() == 1){
                                                    total_cheque_released = total_cheque_released + DE.getTotal();
                                                
                                                %>
                                                    <tr>
                                                        <td><%=DE.getIdsaleInvoice() %></td>
                                                        <td><%=DE.getDate() %></td>
                                                        <td><%=df.format(DE.getTotal()) %></td>
                                                        <td><%=df.format(DE.getPaible()) %></td>
                                            ...
                                            if(account==DE.getAccount().getIdaccount()){
                                            ...
                                            if(account==DE.getAccount().getIdaccount() && branch==DE.getBranch().getIdbranch() ){
