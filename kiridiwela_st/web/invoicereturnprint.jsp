        ...
        <div class="container print">
            <%  
                ...
                if (request.getParameter("pid") != null && !request.getParameter("pid").equals("") ) {
                    ...
                    SalesReturn pi = (SalesReturn) ses.load(SalesReturn.class, Integer.parseInt(request.getParameter("pid").toString()));
                    if (pi != null) {
                ...
                <div class="col-sm-12">
                    ...
                    <div class="col-sm-6">
                        ...
                        <table>
                            ...
                            <tr>
                                <td><p class="mb-0">Remarks :</p></td>
                                <td>&nbsp;<%= pi.getRemark() %></td>
                            </tr>
                            <tr>
                                <td><p class="mb-0">Return ID:</p></td>
                                <td>&nbsp;<%= pi.getIdsalesReturn() %></td>
                            </tr>
                            <tr>
                                <td><p class="mb-0">Amount(RS):</p></td>
                                <td>&nbsp;<%= pi.getAmount() %></td>
                            </tr>
                            <tr>
            ...
            <div class="row mt-2">
                ...
                <table class="table table-sm table-bordered">
                    ...
                    <tbody>
                        <%
                            Set<SalesReturnItems> pii = pi.getSalesReturnItemses();
                            for (SalesReturnItems PII : pii) {

                        %>
                        <tr>
                            <td><%=PII.getItems().getItemId()%></td>
                            <td><%=PII.getItems().getName()%></td>
                            <td class="text-right"><%= PII.getQty() + " " + PII.getType() %> </td>
                            <td class="text-right"><%=PII.getPrice() + "  RS"%></td>
                            <td class="text-right"><%=PII.getTotal() + "  RS"%></td>
                        </tr>
                        <%
                            }
