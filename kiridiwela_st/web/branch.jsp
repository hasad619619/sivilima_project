...
<html lang="en">
            ...
            <div class="row mt-5">
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active" style="font-size: 16px;" aria-current="page">Branch Setup</li>
                        <li class="breadcrumb-item" style="font-size: 16px;"><a href="addnewbranch.jsp"><i class="fa fa-plus"></i> Add new branch</a></li>
                        ...
                        <table id="table1" class="table table-active table-sm">
                            ...
                            <thead>
                                <tr style="background-color: #10ac84 !important; color: white !important; ">
                                    <th id="dev_id" class="dev_id" >BRANCH ID</th>
                                    <th>NAME</th>
                                    <th>STATUS</th>
                                    <th></th>
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <button style="background-color: #eb4d4b ;  color: white;" class="btn  btn-sm delete_dev" id="delete_dev"  value="<%=DE.getIdbranch() %>">DELETE | RESET</button>
                                        ...
                                        <a style="background-color: #6ab04c ;  color: white;" class="btn  btn-sm "  href="updatebranch.jsp?q=<%= DE.getIdbranch() %>" value="<%=DE.getIdbranch()%>">VIEW</a>
                                        <a style="background-color: #f0932b ;  color: white;" class="btn  btn-sm "  href="branchlogosetup.jsp?q=<%= DE.getIdbranch() %>" value="<%=DE.getIdbranch()%>">LOGO SETUP</a>
   ...
   $(window).load(function(){
    ...
    $(".delete_dev").click(function () {
        ...
        swal({
            title: "Are you sure?",
            text: "do you want to "+name+ " category ? ",
            icon: "warning",
            buttons: true,
            dangerMode: true,
            }).then((willDelete) => {
                    if (willDelete) {
                        ...
                        if (data === "1") {
                            ...
                            swal({
                                title: "Good job!",
                                text: "you "+name+ " Branch from list !",
                                icon: "success",
                                button: "OK"
                            }).then((value) => {
